...
def export_pdf():
    ...
    add_text("Objectif : fournir à un chef d'entreprise des indicateurs clairs pour piloter l'activité, identifier les zones rentables, comprendre les comportements de paiement, détecter les anomalies et améliorer la prise de décision.")
